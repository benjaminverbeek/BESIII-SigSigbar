...
benjamin_no_config (from PROJECT) excludes [benjamin_config]
benjamin_root (from PROJECT) excludes [benjamin_no_root]
benjamin_cleanup (from PROJECT) excludes [benjamin_no_cleanup]
benjamin_scripts (from PROJECT) excludes [benjamin_no_scripts]
benjamin_prototypes (from PROJECT) excludes [benjamin_no_prototypes]
benjamin_with_installarea (from PROJECT) excludes [benjamin_without_installarea]
benjamin_with_version_directory (from PROJECT) excludes [benjamin_without_version_directory]
benjamin (from PROJECT)
...
----------> CMTPATH
# Add path /home/benjamin/workarea from initialization
