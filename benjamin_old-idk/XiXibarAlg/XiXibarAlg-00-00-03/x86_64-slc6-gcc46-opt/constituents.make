...
#cmt_local_tagfile = $(XiXibarAlg_tag).make
cmt_local_tagfile = $(bin)$(XiXibarAlg_tag).make
...
cmt_local_setup_XiXibar = $(bin)setup_XiXibar$$$$.make
...
XiXibar_extratags = -tag_add=target_XiXibar

#$(cmt_local_tagfile_XiXibar) : $(cmt_lock_setup)
ifndef QUICK
$(cmt_local_tagfile_XiXibar) ::
else
$(cmt_local_tagfile_XiXibar) :
endif
	$(echo) "(constituents.make) Rebuilding $@"; \
	  if test -f $(cmt_local_tagfile_XiXibar); then /bin/rm -f $(cmt_local_tagfile_XiXibar); fi ; \
	  $(cmtexe) -tag=$(tags) $(XiXibar_extratags) build tag_makefile >>$(cmt_local_tagfile_XiXibar)
	$(echo) "(constituents.make) Rebuilding $(cmt_final_setup_XiXibar)"; \
	  test ! -f $(cmt_local_setup_XiXibar) || \rm -f $(cmt_local_setup_XiXibar); \
	  trap '\rm -f $(cmt_local_setup_XiXibar)' 0 1 2 15; \
	  $(cmtexe) -tag=$(tags) $(XiXibar_extratags) show setup >$(cmt_local_setup_XiXibar) && \
	  if [ -f $(cmt_final_setup_XiXibar) ] && \
	    \cmp -s $(cmt_final_setup_XiXibar) $(cmt_local_setup_XiXibar); then \
	    \rm $(cmt_local_setup_XiXibar); else \
	    \mv -f $(cmt_local_setup_XiXibar) $(cmt_final_setup_XiXibar); fi
...
not_XiXibar_dependencies = { n=0; for p in $?; do m=0; for d in $(XiXibar_dependencies); do if [ $$p = $$d ]; then m=1; break; fi; done; if [ $$m -eq 0 ]; then n=1; break; fi; done; [ $$n -eq 1 ]; }

ifdef STRUCTURED_OUTPUT
XiXibardirs :
	@if test ! -d $(bin)XiXibar; then $(mkdir) -p $(bin)XiXibar; fi
	$(echo) "STRUCTURED_OUTPUT="$(bin)XiXibar
else
XiXibardirs : ;
endif
...
#	$(echo) "STRUCTURED_OUTPUT="$(bin)XiXibar
#
#$(cmt_local_XiXibar_makefile) :: $(XiXibar_dependencies) $(cmt_local_tagfile_XiXibar) build_library_links dirs XiXibardirs
#else
#$(cmt_local_XiXibar_makefile) :: $(XiXibar_dependencies) $(cmt_local_tagfile_XiXibar) build_library_links dirs
#endif
#else
#$(cmt_local_XiXibar_makefile) :: $(cmt_local_tagfile_XiXibar)
#endif

ifdef cmt_XiXibar_has_target_tag

ifndef QUICK
$(cmt_local_XiXibar_makefile) : $(XiXibar_dependencies) build_library_links
	$(echo) "(constituents.make) Building XiXibar.make"; \
	  $(cmtexe) -tag=$(tags) $(XiXibar_extratags) build constituent_config -out=$(cmt_local_XiXibar_makefile) XiXibar
else
$(cmt_local_XiXibar_makefile) : $(XiXibar_dependencies) $(cmt_build_library_linksstamp) $(use_requirements)
	@if [ ! -f $@ ] || [ ! -f $(cmt_local_tagfile_XiXibar) ] || \
	  [ ! -f $(cmt_final_setup_XiXibar) ] || \
	  $(not_XiXibar_dependencies) ; then \
	  test -z "$(cmtmsg)" || \
	  echo "$(CMTMSGPREFIX)" "(constituents.make) Building XiXibar.make"; \
	  $(cmtexe) -tag=$(tags) $(XiXibar_extratags) build constituent_config -out=$(cmt_local_XiXibar_makefile) XiXibar; \
	  fi
endif
...
$(cmt_local_XiXibar_makefile) : $(XiXibar_dependencies) build_library_links
	$(echo) "(constituents.make) Building XiXibar.make"; \
	  $(cmtexe) -f=$(bin)XiXibar.in -tag=$(tags) $(XiXibar_extratags) build constituent_makefile -without_cmt -out=$(cmt_local_XiXibar_makefile) XiXibar
else
$(cmt_local_XiXibar_makefile) : $(XiXibar_dependencies) $(cmt_build_library_linksstamp) $(bin)XiXibar.in
	@if [ ! -f $@ ] || [ ! -f $(cmt_local_tagfile_XiXibar) ] || \
	  [ ! -f $(cmt_final_setup_XiXibar) ] || \
	  $(not_XiXibar_dependencies) ; then \
	  test -z "$(cmtmsg)" || \
...
#	  $(cmtexe) -tag=$(tags) $(XiXibar_extratags) build constituent_makefile -out=$(cmt_local_XiXibar_makefile) XiXibar

XiXibar :: $(XiXibar_dependencies) $(cmt_local_XiXibar_makefile) dirs XiXibardirs
	$(echo) "(constituents.make) Starting XiXibar"
	@if test -f $(cmt_local_XiXibar_makefile); then \
	  $(MAKE) -f $(cmt_local_XiXibar_makefile) XiXibar; \
	  fi
#	@$(MAKE) -f $(cmt_local_XiXibar_makefile) XiXibar
	$(echo) "(constituents.make) XiXibar done"

clean :: XiXibarclean

XiXibarclean :: $(XiXibarclean_dependencies) ##$(cmt_local_XiXibar_makefile)
	$(echo) "(constituents.make) Starting XiXibarclean"
	@-if test -f $(cmt_local_XiXibar_makefile); then \
	  $(MAKE) -f $(cmt_local_XiXibar_makefile) XiXibarclean; \
	fi
	$(echo) "(constituents.make) XiXibarclean done"
#	@-$(MAKE) -f $(cmt_local_XiXibar_makefile) XiXibarclean

##	  /bin/rm -f $(cmt_local_XiXibar_makefile) $(bin)XiXibar_dependencies.make

install :: XiXibarinstall

XiXibarinstall :: $(XiXibar_dependencies) $(cmt_local_XiXibar_makefile)
	$(echo) "(constituents.make) Starting install XiXibar"
	@-$(MAKE) -f $(cmt_local_XiXibar_makefile) install
	$(echo) "(constituents.make) install XiXibar done"

uninstall : XiXibaruninstall

$(foreach d,$(XiXibar_dependencies),$(eval $(d)uninstall_dependencies += XiXibaruninstall))

XiXibaruninstall : $(XiXibaruninstall_dependencies) ##$(cmt_local_XiXibar_makefile)
	$(echo) "(constituents.make) Starting uninstall XiXibar"
	@if test -f $(cmt_local_XiXibar_makefile); then \
	  $(MAKE) -f $(cmt_local_XiXibar_makefile) uninstall; \
	  fi
#	@$(MAKE) -f $(cmt_local_XiXibar_makefile) uninstall
	$(echo) "(constituents.make) uninstall XiXibar done"

remove_library_links :: XiXibaruninstall
...
#cmt_local_tagfile_install_runtime = $(XiXibarAlg_tag)_install_runtime.make
cmt_local_tagfile_install_runtime = $(bin)$(XiXibarAlg_tag)_install_runtime.make
...
#cmt_final_setup_install_runtime = $(bin)XiXibarAlg_install_runtimesetup.make
...
#cmt_local_tagfile_install_runtime = $(XiXibarAlg_tag).make
cmt_local_tagfile_install_runtime = $(bin)$(XiXibarAlg_tag).make
cmt_final_setup_install_runtime = $(bin)setup.make
#cmt_final_setup_install_runtime = $(bin)XiXibarAlgsetup.make
cmt_local_install_runtime_makefile = $(bin)install_runtime.make
...
#cmt_local_tagfile_install_includes = $(XiXibarAlg_tag)_install_includes.make
cmt_local_tagfile_install_includes = $(bin)$(XiXibarAlg_tag)_install_includes.make
...
#cmt_final_setup_install_includes = $(bin)XiXibarAlg_install_includessetup.make
...
#cmt_local_tagfile_install_includes = $(XiXibarAlg_tag).make
cmt_local_tagfile_install_includes = $(bin)$(XiXibarAlg_tag).make
cmt_final_setup_install_includes = $(bin)setup.make
#cmt_final_setup_install_includes = $(bin)XiXibarAlgsetup.make
cmt_local_install_includes_makefile = $(bin)install_includes.make
...
#cmt_local_tagfile_make = $(XiXibarAlg_tag)_make.make
cmt_local_tagfile_make = $(bin)$(XiXibarAlg_tag)_make.make
cmt_local_setup_make = $(bin)setup_make$$$$.make
cmt_final_setup_make = $(bin)setup_make.make
#cmt_final_setup_make = $(bin)XiXibarAlg_makesetup.make
...
#cmt_local_tagfile_make = $(XiXibarAlg_tag).make
cmt_local_tagfile_make = $(bin)$(XiXibarAlg_tag).make
cmt_final_setup_make = $(bin)setup.make
#cmt_final_setup_make = $(bin)XiXibarAlgsetup.make
cmt_local_make_makefile = $(bin)make.make
...
#cmt_local_tagfile_CompilePython = $(XiXibarAlg_tag)_CompilePython.make
cmt_local_tagfile_CompilePython = $(bin)$(XiXibarAlg_tag)_CompilePython.make
cmt_local_setup_CompilePython = $(bin)setup_CompilePython$$$$.make
cmt_final_setup_CompilePython = $(bin)setup_CompilePython.make
#cmt_final_setup_CompilePython = $(bin)XiXibarAlg_CompilePythonsetup.make
...
#cmt_local_tagfile_CompilePython = $(XiXibarAlg_tag).make
cmt_local_tagfile_CompilePython = $(bin)$(XiXibarAlg_tag).make
cmt_final_setup_CompilePython = $(bin)setup.make
#cmt_final_setup_CompilePython = $(bin)XiXibarAlgsetup.make
cmt_local_CompilePython_makefile = $(bin)CompilePython.make
...
#cmt_local_tagfile_qmtest_run = $(XiXibarAlg_tag)_qmtest_run.make
cmt_local_tagfile_qmtest_run = $(bin)$(XiXibarAlg_tag)_qmtest_run.make
cmt_local_setup_qmtest_run = $(bin)setup_qmtest_run$$$$.make
cmt_final_setup_qmtest_run = $(bin)setup_qmtest_run.make
#cmt_final_setup_qmtest_run = $(bin)XiXibarAlg_qmtest_runsetup.make
...
#cmt_local_tagfile_qmtest_run = $(XiXibarAlg_tag).make
cmt_local_tagfile_qmtest_run = $(bin)$(XiXibarAlg_tag).make
cmt_final_setup_qmtest_run = $(bin)setup.make
#cmt_final_setup_qmtest_run = $(bin)XiXibarAlgsetup.make
cmt_local_qmtest_run_makefile = $(bin)qmtest_run.make
...
#cmt_local_tagfile_qmtest_summarize = $(XiXibarAlg_tag)_qmtest_summarize.make
cmt_local_tagfile_qmtest_summarize = $(bin)$(XiXibarAlg_tag)_qmtest_summarize.make
...
#cmt_final_setup_qmtest_summarize = $(bin)XiXibarAlg_qmtest_summarizesetup.make
...
#cmt_local_tagfile_qmtest_summarize = $(XiXibarAlg_tag).make
cmt_local_tagfile_qmtest_summarize = $(bin)$(XiXibarAlg_tag).make
cmt_final_setup_qmtest_summarize = $(bin)setup.make
#cmt_final_setup_qmtest_summarize = $(bin)XiXibarAlgsetup.make
cmt_local_qmtest_summarize_makefile = $(bin)qmtest_summarize.make
...
#cmt_local_tagfile_TestPackage = $(XiXibarAlg_tag)_TestPackage.make
cmt_local_tagfile_TestPackage = $(bin)$(XiXibarAlg_tag)_TestPackage.make
cmt_local_setup_TestPackage = $(bin)setup_TestPackage$$$$.make
cmt_final_setup_TestPackage = $(bin)setup_TestPackage.make
#cmt_final_setup_TestPackage = $(bin)XiXibarAlg_TestPackagesetup.make
...
#cmt_local_tagfile_TestPackage = $(XiXibarAlg_tag).make
cmt_local_tagfile_TestPackage = $(bin)$(XiXibarAlg_tag).make
cmt_final_setup_TestPackage = $(bin)setup.make
#cmt_final_setup_TestPackage = $(bin)XiXibarAlgsetup.make
cmt_local_TestPackage_makefile = $(bin)TestPackage.make
...
#cmt_local_tagfile_TestProject = $(XiXibarAlg_tag)_TestProject.make
cmt_local_tagfile_TestProject = $(bin)$(XiXibarAlg_tag)_TestProject.make
cmt_local_setup_TestProject = $(bin)setup_TestProject$$$$.make
cmt_final_setup_TestProject = $(bin)setup_TestProject.make
#cmt_final_setup_TestProject = $(bin)XiXibarAlg_TestProjectsetup.make
...
#cmt_local_tagfile_TestProject = $(XiXibarAlg_tag).make
cmt_local_tagfile_TestProject = $(bin)$(XiXibarAlg_tag).make
cmt_final_setup_TestProject = $(bin)setup.make
#cmt_final_setup_TestProject = $(bin)XiXibarAlgsetup.make
cmt_local_TestProject_makefile = $(bin)TestProject.make
...
#cmt_local_tagfile_new_rootsys = $(XiXibarAlg_tag)_new_rootsys.make
cmt_local_tagfile_new_rootsys = $(bin)$(XiXibarAlg_tag)_new_rootsys.make
cmt_local_setup_new_rootsys = $(bin)setup_new_rootsys$$$$.make
cmt_final_setup_new_rootsys = $(bin)setup_new_rootsys.make
#cmt_final_setup_new_rootsys = $(bin)XiXibarAlg_new_rootsyssetup.make
...
#cmt_local_tagfile_new_rootsys = $(XiXibarAlg_tag).make
cmt_local_tagfile_new_rootsys = $(bin)$(XiXibarAlg_tag).make
cmt_final_setup_new_rootsys = $(bin)setup.make
#cmt_final_setup_new_rootsys = $(bin)XiXibarAlgsetup.make
cmt_local_new_rootsys_makefile = $(bin)new_rootsys.make
...
#cmt_local_tagfile_DatabaseSvc_check_install_scripts = $(XiXibarAlg_tag)_DatabaseSvc_check_install_scripts.make
cmt_local_tagfile_DatabaseSvc_check_install_scripts = $(bin)$(XiXibarAlg_tag)_DatabaseSvc_check_install_scripts.make
...
#cmt_final_setup_DatabaseSvc_check_install_scripts = $(bin)XiXibarAlg_DatabaseSvc_check_install_scriptssetup.make
...
#cmt_local_tagfile_DatabaseSvc_check_install_scripts = $(XiXibarAlg_tag).make
cmt_local_tagfile_DatabaseSvc_check_install_scripts = $(bin)$(XiXibarAlg_tag).make
cmt_final_setup_DatabaseSvc_check_install_scripts = $(bin)setup.make
#cmt_final_setup_DatabaseSvc_check_install_scripts = $(bin)XiXibarAlgsetup.make
cmt_local_DatabaseSvc_check_install_scripts_makefile = $(bin)DatabaseSvc_check_install_scripts.make
...
cmt_local_setup_XiXibarAlg_check_install_runtime = $(bin)setup_XiXibarAlg_check_install_runtime$$$$.make
...
XiXibarAlg_check_install_runtime_extratags = -tag_add=target_XiXibarAlg_check_install_runtime

#$(cmt_local_tagfile_XiXibarAlg_check_install_runtime) : $(cmt_lock_setup)
ifndef QUICK
$(cmt_local_tagfile_XiXibarAlg_check_install_runtime) ::
else
$(cmt_local_tagfile_XiXibarAlg_check_install_runtime) :
endif
	$(echo) "(constituents.make) Rebuilding $@"; \
	  if test -f $(cmt_local_tagfile_XiXibarAlg_check_install_runtime); then /bin/rm -f $(cmt_local_tagfile_XiXibarAlg_check_install_runtime); fi ; \
	  $(cmtexe) -tag=$(tags) $(XiXibarAlg_check_install_runtime_extratags) build tag_makefile >>$(cmt_local_tagfile_XiXibarAlg_check_install_runtime)
	$(echo) "(constituents.make) Rebuilding $(cmt_final_setup_XiXibarAlg_check_install_runtime)"; \
	  test ! -f $(cmt_local_setup_XiXibarAlg_check_install_runtime) || \rm -f $(cmt_local_setup_XiXibarAlg_check_install_runtime); \
	  trap '\rm -f $(cmt_local_setup_XiXibarAlg_check_install_runtime)' 0 1 2 15; \
	  $(cmtexe) -tag=$(tags) $(XiXibarAlg_check_install_runtime_extratags) show setup >$(cmt_local_setup_XiXibarAlg_check_install_runtime) && \
	  if [ -f $(cmt_final_setup_XiXibarAlg_check_install_runtime) ] && \
	    \cmp -s $(cmt_final_setup_XiXibarAlg_check_install_runtime) $(cmt_local_setup_XiXibarAlg_check_install_runtime); then \
	    \rm $(cmt_local_setup_XiXibarAlg_check_install_runtime); else \
	    \mv -f $(cmt_local_setup_XiXibarAlg_check_install_runtime) $(cmt_final_setup_XiXibarAlg_check_install_runtime); fi
...
not_XiXibarAlg_check_install_runtime_dependencies = { n=0; for p in $?; do m=0; for d in $(XiXibarAlg_check_install_runtime_dependencies); do if [ $$p = $$d ]; then m=1; break; fi; done; if [ $$m -eq 0 ]; then n=1; break; fi; done; [ $$n -eq 1 ]; }

ifdef STRUCTURED_OUTPUT
XiXibarAlg_check_install_runtimedirs :
	@if test ! -d $(bin)XiXibarAlg_check_install_runtime; then $(mkdir) -p $(bin)XiXibarAlg_check_install_runtime; fi
	$(echo) "STRUCTURED_OUTPUT="$(bin)XiXibarAlg_check_install_runtime
else
XiXibarAlg_check_install_runtimedirs : ;
endif
...
#	$(echo) "STRUCTURED_OUTPUT="$(bin)XiXibarAlg_check_install_runtime
#
#$(cmt_local_XiXibarAlg_check_install_runtime_makefile) :: $(XiXibarAlg_check_install_runtime_dependencies) $(cmt_local_tagfile_XiXibarAlg_check_install_runtime) build_library_links dirs XiXibarAlg_check_install_runtimedirs
#else
#$(cmt_local_XiXibarAlg_check_install_runtime_makefile) :: $(XiXibarAlg_check_install_runtime_dependencies) $(cmt_local_tagfile_XiXibarAlg_check_install_runtime) build_library_links dirs
#endif
#else
#$(cmt_local_XiXibarAlg_check_install_runtime_makefile) :: $(cmt_local_tagfile_XiXibarAlg_check_install_runtime)
#endif

ifdef cmt_XiXibarAlg_check_install_runtime_has_target_tag

ifndef QUICK
$(cmt_local_XiXibarAlg_check_install_runtime_makefile) : $(XiXibarAlg_check_install_runtime_dependencies) build_library_links
	$(echo) "(constituents.make) Building XiXibarAlg_check_install_runtime.make"; \
	  $(cmtexe) -tag=$(tags) $(XiXibarAlg_check_install_runtime_extratags) build constituent_config -out=$(cmt_local_XiXibarAlg_check_install_runtime_makefile) XiXibarAlg_check_install_runtime
else
$(cmt_local_XiXibarAlg_check_install_runtime_makefile) : $(XiXibarAlg_check_install_runtime_dependencies) $(cmt_build_library_linksstamp) $(use_requirements)
	@if [ ! -f $@ ] || [ ! -f $(cmt_local_tagfile_XiXibarAlg_check_install_runtime) ] || \
	  [ ! -f $(cmt_final_setup_XiXibarAlg_check_install_runtime) ] || \
	  $(not_XiXibarAlg_check_install_runtime_dependencies) ; then \
	  test -z "$(cmtmsg)" || \
	  echo "$(CMTMSGPREFIX)" "(constituents.make) Building XiXibarAlg_check_install_runtime.make"; \
	  $(cmtexe) -tag=$(tags) $(XiXibarAlg_check_install_runtime_extratags) build constituent_config -out=$(cmt_local_XiXibarAlg_check_install_runtime_makefile) XiXibarAlg_check_install_runtime; \
	  fi
endif
...
$(cmt_local_XiXibarAlg_check_install_runtime_makefile) : $(XiXibarAlg_check_install_runtime_dependencies) build_library_links
	$(echo) "(constituents.make) Building XiXibarAlg_check_install_runtime.make"; \
	  $(cmtexe) -f=$(bin)XiXibarAlg_check_install_runtime.in -tag=$(tags) $(XiXibarAlg_check_install_runtime_extratags) build constituent_makefile -without_cmt -out=$(cmt_local_XiXibarAlg_check_install_runtime_makefile) XiXibarAlg_check_install_runtime
else
$(cmt_local_XiXibarAlg_check_install_runtime_makefile) : $(XiXibarAlg_check_install_runtime_dependencies) $(cmt_build_library_linksstamp) $(bin)XiXibarAlg_check_install_runtime.in
	@if [ ! -f $@ ] || [ ! -f $(cmt_local_tagfile_XiXibarAlg_check_install_runtime) ] || \
	  [ ! -f $(cmt_final_setup_XiXibarAlg_check_install_runtime) ] || \
	  $(not_XiXibarAlg_check_install_runtime_dependencies) ; then \
	  test -z "$(cmtmsg)" || \
...
#	  $(cmtexe) -tag=$(tags) $(XiXibarAlg_check_install_runtime_extratags) build constituent_makefile -out=$(cmt_local_XiXibarAlg_check_install_runtime_makefile) XiXibarAlg_check_install_runtime

XiXibarAlg_check_install_runtime :: $(XiXibarAlg_check_install_runtime_dependencies) $(cmt_local_XiXibarAlg_check_install_runtime_makefile) dirs XiXibarAlg_check_install_runtimedirs
	$(echo) "(constituents.make) Starting XiXibarAlg_check_install_runtime"
	@if test -f $(cmt_local_XiXibarAlg_check_install_runtime_makefile); then \
	  $(MAKE) -f $(cmt_local_XiXibarAlg_check_install_runtime_makefile) XiXibarAlg_check_install_runtime; \
	  fi
#	@$(MAKE) -f $(cmt_local_XiXibarAlg_check_install_runtime_makefile) XiXibarAlg_check_install_runtime
	$(echo) "(constituents.make) XiXibarAlg_check_install_runtime done"

clean :: XiXibarAlg_check_install_runtimeclean

XiXibarAlg_check_install_runtimeclean :: $(XiXibarAlg_check_install_runtimeclean_dependencies) ##$(cmt_local_XiXibarAlg_check_install_runtime_makefile)
	$(echo) "(constituents.make) Starting XiXibarAlg_check_install_runtimeclean"
	@-if test -f $(cmt_local_XiXibarAlg_check_install_runtime_makefile); then \
	  $(MAKE) -f $(cmt_local_XiXibarAlg_check_install_runtime_makefile) XiXibarAlg_check_install_runtimeclean; \
	fi
	$(echo) "(constituents.make) XiXibarAlg_check_install_runtimeclean done"
#	@-$(MAKE) -f $(cmt_local_XiXibarAlg_check_install_runtime_makefile) XiXibarAlg_check_install_runtimeclean

##	  /bin/rm -f $(cmt_local_XiXibarAlg_check_install_runtime_makefile) $(bin)XiXibarAlg_check_install_runtime_dependencies.make

install :: XiXibarAlg_check_install_runtimeinstall

XiXibarAlg_check_install_runtimeinstall :: $(XiXibarAlg_check_install_runtime_dependencies) $(cmt_local_XiXibarAlg_check_install_runtime_makefile)
	$(echo) "(constituents.make) Starting install XiXibarAlg_check_install_runtime"
	@-$(MAKE) -f $(cmt_local_XiXibarAlg_check_install_runtime_makefile) install
	$(echo) "(constituents.make) install XiXibarAlg_check_install_runtime done"

uninstall : XiXibarAlg_check_install_runtimeuninstall

$(foreach d,$(XiXibarAlg_check_install_runtime_dependencies),$(eval $(d)uninstall_dependencies += XiXibarAlg_check_install_runtimeuninstall))

XiXibarAlg_check_install_runtimeuninstall : $(XiXibarAlg_check_install_runtimeuninstall_dependencies) ##$(cmt_local_XiXibarAlg_check_install_runtime_makefile)
	$(echo) "(constituents.make) Starting uninstall XiXibarAlg_check_install_runtime"
	@if test -f $(cmt_local_XiXibarAlg_check_install_runtime_makefile); then \
	  $(MAKE) -f $(cmt_local_XiXibarAlg_check_install_runtime_makefile) uninstall; \
	  fi
#	@$(MAKE) -f $(cmt_local_XiXibarAlg_check_install_runtime_makefile) uninstall
	$(echo) "(constituents.make) uninstall XiXibarAlg_check_install_runtime done"

remove_library_links :: XiXibarAlg_check_install_runtimeuninstall
